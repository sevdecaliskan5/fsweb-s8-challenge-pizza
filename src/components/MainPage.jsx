      ...
      <main className="main-page">
        <section className="cards">
          <div className="card-1">
            <img src="/images/iteration-2-images/cta/kart-1.png" alt="İlk Kart" />
          ...
          <div className="card-2">
            <img src="/images/iteration-2-images/cta/kart-2.png" alt="İkinci Kart" />
            <div className="overlay-content">
              <h1 className="card-title">
                Hackhathlon <br />
                Burger Menu
          ...
          <div className="card-2">
            <img src="/images/iteration-2-images/cta/kart-3.png" alt="İkinci Kart" />
            <div className="overlay-content">
              <h1 className="card-title">
